...
begin
  ...
  case Key of
    ...
    VK_ADD:        begin MyKey := keyNumpadPlus;      MyCharKey := '+';        end;
    VK_SUBTRACT:   begin MyKey := keyNumpadMinus;     MyCharKey := '-';        end;
    ...
    VK_NUMPAD0:    begin MyKey := keyNumpad0;         MyCharKey := '0'; end;
    VK_NUMPAD1:    begin MyKey := keyNumpad1;         MyCharKey := '1'; end;
    VK_NUMPAD2:    begin MyKey := keyNumpad2;         MyCharKey := '2'; end;
    VK_NUMPAD3:    begin MyKey := keyNumpad3;         MyCharKey := '3'; end;
    VK_NUMPAD4:    begin MyKey := keyNumpad4;         MyCharKey := '4'; end;
    VK_NUMPAD5:    begin MyKey := keyNumpad5;         MyCharKey := '5'; end;
    VK_NUMPAD6:    begin MyKey := keyNumpad6;         MyCharKey := '6'; end;
    VK_NUMPAD7:    begin MyKey := keyNumpad7;         MyCharKey := '7'; end;
    VK_NUMPAD8:    begin MyKey := keyNumpad8;         MyCharKey := '8'; end;
    VK_NUMPAD9:    begin MyKey := keyNumpad9;         MyCharKey := '9'; end;
    VK_CLEAR:            MyKey := keyNumpadBegin;
    VK_MULTIPLY:   begin MyKey := keyNumpadMultiply;  MyCharKey := '*'; end;
    VK_DIVIDE:     begin MyKey := keyNumpadDivide;    MyCharKey := '/'; end;
